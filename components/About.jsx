      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        ...
        <div className="text-center mt-16">
          <RocketReveal delay={3200} isVisible={isVisible}>
            <button className="group relative inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-gray-600 via-gray-900 to-white rounded-full text-white font-semibold text-lg shadow-2xl shadow-purple-500/25 hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105 overflow-hidden">
